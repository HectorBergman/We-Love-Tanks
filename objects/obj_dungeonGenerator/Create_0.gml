var startPoint = [1,1]
var spezRooms = [
	createSpecialRoom("item", "normal", posRequirement(coordsWithinRangeChebyshev,[startPoint, 0,3])),
	createSpecialRoom("boss", "normal", posRequirement(coordsWithinRangeChebyshev_edgesOnly,[startPoint, 0,3]))
]
