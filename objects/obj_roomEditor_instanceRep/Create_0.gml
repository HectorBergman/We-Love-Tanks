...
function createCorners(){
	for (var i = 0; i < 4; i++){
		corners[i] = summonObject(obj_roomEditor_instanceRep_highlightCorners, [["x", x+sprite_width/2] ,["y", y+sprite_height/2], ["image_angle", i*90], ["index",i], ["depth", depth-1], ["parent", id]])
	}
}
