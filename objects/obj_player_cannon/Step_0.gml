...
if obj_inputHandler.fire && !place_meeting(x,y, obj_solid) && activeBullets < maxBullets && firingCooldown < 1{
	var extraInfo = [["bulletGrowthStart", 0.3], ["bulletGrowthEnd", 1], ["bulletGrowthRate", 0.05]]
	fireBullet(obj_bullet_player,bulletSpeed,bulletBounces,bulletDamage,image_angle, global.playerBarrelLength, true, bulletDurability, 
		extraInfo
	);
