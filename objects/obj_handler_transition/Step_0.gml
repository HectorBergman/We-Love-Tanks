	...
	case transitionPhase.start:
		...
		for (var i = 0; i < 31; i++){
			summonObject(obj_transitionStar,
				[["x", -764-i*starSpacing+startOffset[0]], ["y", 1008+i*starSpacing+startOffset[1]], ["delay", 0],
				["tweenTime", tweenTime], ["totalDelay", totalDelay], ["tMult", tMult], ["depth", -1],
				["spinSpeed", 2.4],["offset", startOffset], ["transitionId", transitionId]]);
		}
		for (var i = 0; i < 29; i++){
			summonObject(obj_transitionStar,
				[["x", -880-i*starSpacing+startOffset[0]], ["y", 1008+i*starSpacing+startOffset[1]], ["delay", 0],
				["tweenTime", tweenTime], ["totalDelay", totalDelay], ["tMult", tMult], ["depth", -1],
				["spinSpeed", 2.5],["offset", startOffset], ["transitionId", transitionId]]);
		}
		for (var i = 0; i < 27; i++){
			summonObject(obj_transitionStar,
				[["x", -996-i*starSpacing+startOffset[0]], ["y", 1008+i*starSpacing+startOffset[1]], ["delay", 0],
				["tweenTime", tweenTime], ["totalDelay", totalDelay], ["tMult", tMult], ["depth", -1],
